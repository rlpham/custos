...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */(window),Ne.getInstance().firebaseAppInstance=e,Ne.getInstance().installationsService=t,new st(e)};e.INTERNAL.registerComponent(new s("performance",e=>{const n=e.getProvider("app").getImmediate(),r=e.getProvider("installations").getImmediate();return t(n,r)},"PUBLIC")),e.registerVersion("@firebase/performance","0.2.37")}(E);
/**
     * @license
     * Copyright 2019 Google Inc.
     *
     ...
     * limitations under the License.
     */
return E.registerVersion("firebase","7.13.2","lite"),E}));
